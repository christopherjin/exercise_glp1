...
Contains code, data, and visualizations that allow for reproduction of
“The effect of sex and endurance exercise training on the incretin
signaling pathway in 17 rat tissues”.

The code to generate all figures, except Fig2E, are found in
`glp1a_exploration.Rmd`. Figure 2E, and other epigenetic exploration, is
found in `glp1a_epi.Rmd`. The html knitouts for these notebooks can be
...
<a href="https://github.com/christopherjin/exercise_glp1/issues"
...
- Data used in the preparation of this article were obtained from the
  Molecular Transducers of Physical Activity Consortium (MoTrPAC)
  MotrpacRatTraining6moData R package \[2.0.0\].
